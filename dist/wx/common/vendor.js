...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_mpvue_loader_lib_selector_type_script_index_0_NavigationBar_vue__ = __webpack_require__(88);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_mpvue_loader_lib_template_compiler_index_id_data_v_6c2e1336_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_fileExt_template_wxml_script_js_style_wxss_platform_wx_node_modules_mpvue_loader_lib_selector_type_template_index_0_NavigationBar_vue__ = __webpack_require__(96);
var disposed = false
...
/* scopeId */
var __vue_scopeId__ = "data-v-6c2e1336"
/* moduleIdentifier (server only) */
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_mpvue_loader_lib_template_compiler_index_id_data_v_6c2e1336_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_fileExt_template_wxml_script_js_style_wxss_platform_wx_node_modules_mpvue_loader_lib_selector_type_template_index_0_NavigationBar_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6c2e1336", Component.options)
  } else {
    hotAPI.reload("data-v-6c2e1336", Component.options)
  }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_mpvue_loader_lib_selector_type_script_index_0_tabBar_vue__ = __webpack_require__(152);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_mpvue_loader_lib_template_compiler_index_id_data_v_54a259d7_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_fileExt_template_wxml_script_js_style_wxss_platform_wx_node_modules_mpvue_loader_lib_selector_type_template_index_0_tabBar_vue__ = __webpack_require__(153);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-54a259d7"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_mpvue_loader_lib_template_compiler_index_id_data_v_54a259d7_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_fileExt_template_wxml_script_js_style_wxss_platform_wx_node_modules_mpvue_loader_lib_selector_type_template_index_0_tabBar_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-54a259d7", Component.options)
  } else {
    hotAPI.reload("data-v-54a259d7", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    created: function created() {
        ...
        var ratio = systemInfo.screenHeight / systemInfo.screenWidth; // 高宽比例
        var isNewModel = ratio >= 2;
        var isIPhone = systemInfo.model.indexOf('iPhone') >= 0;
        var barHeight = systemInfo.statusBarHeight || (isNewModel ? this.$StatusBar.newModel : isIPhone ? this.$StatusBar.iPhone : this.$StatusBar.android);
        this.paddingTop = barHeight;
        this.height = barHeight + this.$NavigationBar.default;
        var barStyle = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({}, this.$NavBarStyle);
        barStyle.height = this.$NavigationBar.default;
        this.barStyle = barStyle;
    },

    methods: {
        goBack: function goBack(title) {
            console.log(title);
            if (title === '图文' && getApp().articeParts.length != 0) {
                //图文列表返回有数据时展示返回草稿页面
                wx.showModal({
                    title: '',
        ...
        getMenuSettings: function getMenuSettings(current, count) {
            var _this = this;

            // let menuSettings = wx.getMenuButtonBoundingClientRect()
            var menuSettings = void 0;
            try {
                menuSettings = wx.getMenuButtonBoundingClientRect ? wx.getMenuButtonBoundingClientRect() : null;
                if (!menuSettings) {
            ...
            if (menuSettings.height === 0) {
                ...
                setTimeout(function () {
                    _this.getMenuSettings(current + 1, count);
                }, 200);
            } else {
                this.menuSettings = menuSettings;
            }
        },
        activeBtnClick: function activeBtnClick() {
            this.active = !this.active;
        },
        squareBtnClick: function squareBtnClick() {
            this.active = false;
            this.activeTitle = '广场';
        },
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('div', {
    staticClass: "navigation-bar color-000",
    style: ({
      paddingTop: _vm.paddingTop + 'px',
      height: _vm.height + 'px',
      backgroundColor: _vm.background || _vm.barStyle.background
    })
  }, [(_vm.isIndex) ? _c('div', {
    staticClass: "isIndex box"
  }, [_c('div', {
    staticClass: "h_search"
  }, [_c('div', {
    staticClass: "top_sort fl clearfix",
    attrs: {
      "eventid": '0'
    },
    on: {
    ...
    staticClass: "selected fl color-333 fontbold"
  }, [_vm._v(_vm._s(_vm.activeTitle))]), _vm._v(" "), _c('span', {
    staticClass: "icon icon_arrow fl",
    class: _vm.active ? 'active' : ''
  })]), _vm._v(" "), (_vm.active) ? _c('div', {
    staticClass: "select_box color-333 f36"
  }, [_c('div', {
    staticClass: "option",
    attrs: {
      "eventid": '1'
  ...
  }, [_vm._v("关注")])]) : _vm._e()]), _vm._v(" "), _c('div', {
    staticClass: "appName",
    style: ({
      textAlign: _vm.barStyle.textAlign,
      color: _vm.color || _vm.barStyle.color,
      fontSize: _vm.barStyle.fontSize + 'px',
      lineHeight: _vm.barStyle.height + 'px',
      fontWeight: 'bold'
    })
  }, [_vm._v(_vm._s(_vm.appName) + "\n            ")])]) : _vm._e(), _vm._v(" "), (_vm.isMine) ? _c('div', {
    staticClass: "isMine box"
  }, [(_vm.isLogin) ? _c('div', {
    staticClass: "handler clearfix"
  }, [_c('navigator', {
    staticClass: "icon i_set",
    attrs: {
      "hover-class": "none",
    ...
    attrs: {
      "src": "/static/images/my_set.svg"
    }
  })]), _vm._v(" "), _vm._m(0)], 1) : _vm._e(), _vm._v(" "), (_vm.title) ? _c('div', {
    staticClass: "title",
    style: ({
      textAlign: 'center',
      fontWeight: 'bold',
  ...
  }, [_vm._v("\n                " + _vm._s(_vm.title) + "\n            ")]) : _vm._e()]) : _vm._e(), _vm._v(" "), (!_vm.isIndex && !_vm.isMine) ? _c('div', {
    staticClass: "box"
  }, [_c('div', {}, [(_vm.showBack) ? _c('div', {
    staticClass: "goback",
    style: ({
      height: _vm.barStyle.height + 'px',
      lineHeight: _vm.barStyle.height + 'px'
    }),
    attrs: {
      "eventid": '3'
    ...
    on: {
      "click": function($event) {
        _vm.goBack(_vm.title)
      }
    }
  }, [_c('image', {
    attrs: {
      "src": "/static/tabs/back.svg",
      "alt": ""
    }
  ...
  }, [_vm._v("\n                    " + _vm._s(_vm.title) + "\n                ")]) : _vm._e(), _vm._v(" "), (_vm.showShare) ? _c('div', {
    staticClass: "icon_share"
  }, [_c('image', {
    attrs: {
      "src": "/static/images/my_share.svg",
      "alt": ""
    }
  })]) : _vm._e(), _vm._v(" "), (_vm.showAppName) ? _c('div', {
    staticClass: "title showCenter",
    style: ({
      textAlign: 'center',
      fontWeight: 'bold',
      color: _vm.color || _vm.barStyle.color,
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-6c2e1336", esExports)
  }
}
...
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    return _c('div', {
      ...
      class: _vm.currentNavIndex === index ? 'active' : '',
      style: ({
      ...
      attrs: {
        "mode": "aspectFit",
        "src": _vm.currentNavIndex === index ? item.selectedIconPath : item.iconPath,
        "animation": item.isSpecial ? _vm.animation : '',
        "alt": "iconPath"
      }
    })]), _vm._v(" "), (item.text) ? _c('p', {
      staticClass: "f24 footer-word",
      style: ({
        color: _vm.currentNavIndex === index ? _vm.tabBar.selectedColor : _vm.tabBar.color
      })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-54a259d7", esExports)
  }
}
